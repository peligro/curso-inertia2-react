...
const Home = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route('huggingface_index_post'), {
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
                setData('pregunta', '');
                ...
                <div className="col-12">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Generar imagen con Hugging Face</li>
                        </ol>
                    </nav> 
                    <h1>Generar imagen con Hugging Face</h1>
